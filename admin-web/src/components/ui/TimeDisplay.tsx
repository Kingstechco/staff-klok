...
export default function TimeDisplay({ className = '', collapsible = false }: TimeDisplayProps) {
  ...
  return (
    <div className={`inline-flex flex-col bg-gradient-to-br from-white/90 to-slate-50/80 rounded-2xl border border-slate-200/60 shadow-xl backdrop-blur-sm group hover:shadow-2xl hover:shadow-slate-500/10 transition-all duration-300 ${isCollapsed ? 'p-3' : 'p-5'} ${className}`}>
      ...
      {isCollapsed ? (
        <div className="flex items-center justify-between gap-3">
          ...
          {/* Status Indicator and Collapse Toggle */}
          <div className="flex items-center gap-2">
            ...
            {collapsible && (
              ...
              >
                <div className="h-3 w-3 text-slate-500 hover:text-indigo-600 transition-all duration-300 transform rotate-180">
        ...
        <>
          {/* Header with Time Format Toggle and Collapse Button */}
          <div className="flex items-center justify-between gap-2 mb-3">
            ...
            {collapsible && (
              ...
              >
                <div className="h-3 w-3 text-slate-500 hover:text-indigo-600 transition-all duration-300">
                  <ChevronUpIcon className="h-3 w-3" />
                </div>
              </button>
            )}
          ...
          {/* Main Time Display */}
          <div className="text-3xl font-black font-mono bg-gradient-to-r from-slate-800 via-slate-700 to-slate-900 bg-clip-text text-transparent group-hover:from-indigo-600 group-hover:via-purple-600 group-hover:to-indigo-800 transition-all duration-500 text-center">
