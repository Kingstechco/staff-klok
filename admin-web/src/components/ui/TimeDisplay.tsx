...
export default function TimeDisplay({ className = '' }: TimeDisplayProps) {
  ...
  return (
    <div className={`inline-flex flex-col items-end p-5 bg-gradient-to-br from-white/90 to-slate-50/80 rounded-2xl border border-slate-200/60 shadow-xl backdrop-blur-sm group hover:shadow-2xl hover:shadow-slate-500/10 transition-all duration-300 ${className}`}>
      {/* Time Format Toggle */}
